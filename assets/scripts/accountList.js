...
const getAccounts = async () => {
  const fetchaccounts = await ftechAPI(
    "https://tn-travelxd.herokuapp.com/api/v1/users",
    "GET",
    JSON.stringify({})
  );
...
const updateRole = async (id) => {
  ...
  const fetchUpdateAccounts = await ftechAPI(
    "https://tn-travelxd.herokuapp.com/api/v1/users/promote",
    "PATCH",
    JSON.stringify({
      email: id,
...
const findUser = async () => {
  ...
  users = await ftechAPI(
    `https://tn-travelxd.herokuapp.com/api/v1/users/find?text=${
